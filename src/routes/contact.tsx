...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Contact our Unionville dental practice. Call (905) 477-5825, email drdudley@bellnet.ca, or send us a message." },
      { property: "og:title", content: "Contact — Unionville Dentist" },
      { property: "og:description", content: "Call, email, or send a message to book your appointment." },
    ],
  }),
  component: Contact,
});
    ...
    <>
      ...
      <section className="container-prose grid lg:grid-cols-12 gap-10">
        <div className="lg:col-span-5 space-y-4">
          <a href="tel:9054775825" className="block rounded-2xl border border-border bg-card p-6 hover:border-primary/40 transition">
          ...
          <a href="mailto:drdudley@bellnet.ca" className="block rounded-2xl border border-border bg-card p-6 hover:border-primary/40 transition">
          ...
          <div className="rounded-2xl border border-border bg-card p-6">
            ...
            <div className="mt-1 text-foreground">4359 Highway #7<br/>Unionville, ON L3R 1M1</div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7">
          <form
            onSubmit={(e) => {
              ...
              const subject = encodeURIComponent("Appointment request — " + (data.get("name") || ""));
          ...
          >
            ...
            {sent && (
              <p className="text-sm text-[var(--clay)]">Thanks — your mail app should now be open with your message ready to send.</p>
            )}
          </form>
        </div>
      </section>
